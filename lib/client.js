...
class PMDClient extends events.EventEmitter {
    ...
    connect() {
        ...
        try {
            ...
            throw new Error("Socket does not exist or dont can be access");
        }

        if (!sockStatus.isSocket()) {
            throw new Error("Socket file exists but isn't a socket");
        }
